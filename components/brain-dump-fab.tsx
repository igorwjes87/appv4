    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-[calc(5rem+env(safe-area-inset-bottom,8px))] right-4 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-[0_4px_20px_rgba(0,212,255,0.4)] active:scale-[0.93] transition-all animate-neon-pulse"
